...
const WEEKLY_CONTENT: Record<number, { baby: string; mom: string; tip: string }> = {
  ...
  12: { baby: 'Fim do período mais crítico! Bebê com 6cm, reflexos presentes.', mom: 'As náuseas tendem a diminuir. Barriga começa a aparecer.', tip: 'Realize o rastreamento combinado de 1º trimestre (TN + bioquímica).' },
  ...
  15: { baby: 'Bebê com 10cm. Desenvolvimento acelerado.', mom: 'Barriga mais evidente. Apetite aumenta.', tip: 'Ultrassom morfológico será realizado entre 20–24 semanas.' },
  16: { baby: 'Bebê com 12cm. Pode chupar o polegar e fazer caretas!', mom: 'Você pode começar a sentir os primeiros movimentos (flutulações).', tip: 'Ultrassom morfológico pode ser agendado entre 18-22 semanas.' },
