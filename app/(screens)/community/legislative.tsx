...
const VICTORIES = [
  {
    ...
    date: '2018',
    description: 'Incorporação pela CONITEC da cobertura de heparinas de baixo peso molecular para gestantes com trombofilia pelo Sistema Único de Saúde.',
    status: 'Conquistada',
    icon: '🏆',
  },
  {
    id: '2',
    title: 'Política Nacional de Humanização do Luto Materno e Parental',
    date: '2025',
    description: 'Política que garante avanços importantes no acolhimento e investigação das perdas gestacionais, reconhecendo a importância da humanização no luto parental.',
    status: 'Conquistada',
    icon: '📋',
  },
  {
  ...
  {
    id: '4',
    title: 'PL 330 de 2023',
    date: 'Em andamento',
    description: 'Projeto de Lei em discussão para ampliação de direitos e acesso a recursos para mulheres com trombofilia durante a gestação.',
    status: 'Em andamento',
    icon: '⚖️',
  },
];
